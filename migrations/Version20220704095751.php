 ...
 */
final class Version20220704095751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matieres CHANGE id_niveau_id niveau_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matieres CHANGE niveau_id id_niveau_id INT DEFAULT NULL');
